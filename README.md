...
Khi backend trả `query.intent: "locate_event"`, giao diện dùng `location_events`, mỗi `event_key` là một thẻ sự kiện. Hiển thị đầy đủ chuỗi địa điểm với nhãn “Địa điểm được nhắc tới”. Các liên kết bài viết chỉ hiển thị trong mục “Bài viết nguồn” để tránh lặp lại dưới từng địa điểm.
